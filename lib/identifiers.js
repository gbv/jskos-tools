...
function compare(mapping1, mapping2, prefix) {
  mapping1 = addMappingIdentifiers(mapping1)
  mapping2 = addMappingIdentifiers(mapping2)
  let id1 = mapping1.identifier.find(element => element.startsWith(prefix))
  let id2 = mapping2.identifier.find(element => element.startsWith(prefix))
  return id1 == id2
}
