...
const minifyMapping = mapping => {
  let newMapping = _.pick(copyDeep(mapping), ["to", "from", "toScheme", "fromScheme", "creator", "type"])
...
module.exports = {
  clean, cleanJSKOS, copyDeep, deepCopy, getAllUris, compare,compareObjects, compareSchemes, compareConcepts, isConcept, isScheme, isContainedIn, isSchemeInList, sortConcepts, sortSchemes, minifyMapping,
}
